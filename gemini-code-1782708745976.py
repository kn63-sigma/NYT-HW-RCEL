...
# 1. Establish dataset with explicit whole-number metrics
data = {
    'Necessity': [
...
# 2. Melt dataframe for perfect Plotly compatibility and custom hover string construction
...
# 3. Exact NYT Color Palette mapping
color_map = {
    'Unaffordable': '#e28743',
...
# 5. Streamlit Deployment Entrypoint using the correct width parameter
